...
def test_quick_sort_empty_arr():
    arr = []
    assert quick_sort(arr) == arr

def test_quick_sort_single_arr():
    arr = [5]
    assert quick_sort(arr) == arr

def test_quick_sort_sorted_arr():
    arr = [1, 2, 3, 4, 5]
    assert quick_sort(arr) == arr
...
def test_quick_sort_duplicates():
    arr = [3, 1, 2, 3, 1, 2]
    assert quick_sort(arr) == [1, 1, 2, 2, 3, 3]

def test_quick_sort_negative():
    arr = [-5, -1, -3, -2, -4]
    assert quick_sort(arr) == [-5, -4, -3, -2, -1]

def test_quick_sort_mixed():
    arr = [3, -2, 0, -1, 5]
    assert quick_sort(arr) == [-2, -1, 0, 3, 5]
